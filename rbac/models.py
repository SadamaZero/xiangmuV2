...
class User2Role(models.Model):
    ...
    r = models.ForeignKey(Role, on_delete=models.DO_NOTHING)
    class Meta:
...
class Menu(models.Model):
    caption = models.CharField(max_length=32)
    parent = models.ForeignKey('self',related_name='p',null=True,blank=True, on_delete=models.DO_NOTHING)
    def __str__(self):
...
class Permission2Action(models.Model):
    p = models.ForeignKey(Permission, on_delete=models.DO_NOTHING)
    a = models.ForeignKey(Action, on_delete=models.DO_NOTHING)
...
class Permission2Action2Role(models.Model):
    p2a = models.ForeignKey(Permission2Action, on_delete=models.DO_NOTHING)
    r = models.ForeignKey(Role, on_delete=models.DO_NOTHING)
    class Meta:
